...
const Data: FC<Props> = (props: Props) => {
  ...
  return (
    <div className="relative bg-cf-green-950 md:bg-transparent md:bg-dashboardData -mt-1 px-2 w-full h-[110px] md:h-[70px]  overflow-hidden">
      ...
      <div className="absolute -bottom-7 inset-x-0 -z-[1] h-[33px] w-full md:w-[97.9%] xl:w-[98.8%] md:ml-[18px] overflow-hidden">
        <Image
          src="/images/pages/dashboard/data-dots.svg"
          fill
